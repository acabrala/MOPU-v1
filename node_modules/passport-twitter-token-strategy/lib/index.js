...
var TwitterTokenStrategy = (function (_OAuthStrategy) {
  ...
  _createClass(TwitterTokenStrategy, [{
    ...
    value: function userProfile(token, tokenSecret, params, done) {
      this._oauth.get('https://api.twitter.com/1.1/account/verify_credentials.json?include_email=true&user_id=' + params.user_id, token, tokenSecret, function (error, body, res) {
